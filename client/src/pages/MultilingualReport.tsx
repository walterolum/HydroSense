          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <button type="button" onClick={() => fileRef.current?.click()}
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold border-2 border-dashed border-gray-300 text-gray-600 hover:border-blue-300 hover:text-blue-600 transition-colors w-full justify-center">
                {imagePreview ? <Image size={16} /> : <Camera size={16} />}
                {imagePreview ? 'Change Photo' : t('report.photo')}
              </button>
              {imagePreview && (
