...
const UI_STRINGS: Record<string, Record<string, string>> = {
  ...
  'report.title': {
    ...
    myx: 'Siima Lipooti', kdj: 'Ikar Riipota', spy: 'Tun Ripooto',
  },
  'report.description': {
  ...
  'report.voice': {
    ...
    myx: 'Oyize Eddoboozi', kdj: 'Ikir Aitu', spy: 'Yom Kobil',
  },
  'report.type': {
    ...
    nyo: 'Ekika', ttj: 'Ekika', laj: 'Kit', alz: 'Kit', myx: 'Ekika', kdj: 'Aibe', spy: 'Kibwech',
  },
  'report.location': {
    en: 'Location', lug: 'Walawo', nyn: 'Aha', teo: 'Ka', luo: 'Wang',
    lgg: 'Lu', xog: 'Walawo', cgg: 'Aha', ach: 'Wang', swa: 'Mahali',
    nyo: 'Aha', ttj: 'Aha', laj: 'Kabedo', alz: 'Kakuot', myx: 'Walawo', kdj: 'Ka', spy: 'Iman',
  },
  'report.district': {
    ...
    myx: 'Disitulikiti', kdj: 'Disitulikiti', spy: 'Distrikto',
  },
  'report.subcounty': {
    ...
    myx: 'Ggombolola', kdj: 'Sub-county', spy: 'Sub-county',
  },
  'report.village': {
    en: 'Village', lug: 'Kyalo', nyn: 'Omugyenge', teo: 'Ader', luo: 'Gweng',
    lgg: 'Anga', xog: 'Kyalo', cgg: 'Omugyenge', ach: 'Gweng', swa: 'Kijiji',
    nyo: 'Omugyenge', ttj: 'Omugyenge', laj: 'Gweng', alz: 'Wang', myx: 'Kyalo', kdj: 'Ader', spy: 'Soget',
  },
  'report.photo': {
    ...
    myx: 'Funa Ekifaananyi', kdj: 'Ikir Foto', spy: 'Bo Foto',
  },
  'report.anonymous': {
    ...
    myx: 'Siima Lipooti Mu Kukyama', kdj: 'Ikar Riipota Kona', spy: 'Tun Ripooto Komanech',
  },
  'report.track': {
    ...
    myx: 'Londolola Lipooti Yange', kdj: 'Ikir Riipota Ka', spy: 'Luwan Ripooto Koi',
  },
  'report.SMS': {
    ...
    myx: 'Siima SMS', kdj: 'Ikar SMS', spy: 'Tun SMS',
  },
  'report.whatsapp': {
    ...
    myx: 'Siima WhatsApp', kdj: 'Ikar WhatsApp', spy: 'Tun WhatsApp',
  },
  'report.phone': {
  ...
  'auth.password': {
    ...
    nyo: 'Ekihisho', ttj: 'Ekihisho', laj: 'Mung', alz: 'Mung', myx: 'Ekinyigi Kyama', kdj: 'Ekihisho', spy: 'Choraan',
  },
  'auth.language': {
    ...
    myx: "Olulimi Lw'oyagala", kdj: 'Akaidi', spy: 'Kobil Koi',
  },
  'auth.phone': {
    ...
    myx: 'Enamba ya Simu', kdj: 'Simu Namba', spy: 'Simu Namba',
  },
  'auth.name': {
    ...
    nyo: 'Eizina', ttj: 'Eizina', laj: 'Nying', alz: 'Nying', myx: 'Erinya', kdj: 'Ekon', spy: 'Raran',
  },
  'chat.title': {
    ...
    myx: 'Muyambi wa Hydro AI', kdj: 'Muyambi wa Hydro AI', spy: 'Muyambi wa Hydro AI',
  },
  'chat.placeholder': {
  ...
  'chat.send': {
    ...
    nyo: 'Kohereza', ttj: 'Kohereza', laj: 'Cwalo', alz: 'Cwal', myx: 'Tuma', kdj: 'Ikar', spy: 'Tun',
  },
  'chat.voice': {
    en: 'Voice Message', lug: 'Ebboozi', nyn: 'Orurari', teo: 'Aitu', luo: 'Dwoko',
    lgg: 'Voisi', xog: 'Ebboozi', cgg: 'Orurari', ach: 'Dwoko', swa: 'Sauti',
    nyo: 'Orurari', ttj: 'Orurari', laj: 'Dwoko', alz: 'Dwoko', myx: 'Eddoboozi', kdj: 'Aitu', spy: 'Kobil',
  },
  'status.submitted': {
    en: 'Submitted', lug: 'Kuwawo', nyn: 'Kureetwa', teo: 'Ikir', luo: 'Ochuk',
    lgg: 'Tumawa', xog: 'Kuwawo', cgg: 'Kureetwa', ach: 'Ochuk', swa: 'Imewasilishwa',
    nyo: 'Kureetwa', ttj: 'Kureetwa', laj: 'Okicwalo', alz: 'Ocwalo', myx: 'Waweebwa', kdj: 'Iparit', spy: 'Ochebo',
  },
  'status.investigating': {
    ...
    myx: 'Kupeereza', kdj: 'Aipar', spy: 'Tyo ka nono',
  },
  'status.assigned': {
    ...
    nyo: 'Kuheerwa', ttj: 'Kuheerwa', laj: 'Omiye', alz: 'Omiye', myx: 'Weeberwa', kdj: 'Ikir', spy: 'Omiye',
  },
  'status.resolved': {
    ...
    nyo: 'Kuharurwa', ttj: 'Kuharurwa', laj: 'Otum', alz: 'Otum', myx: 'Kutereeza', kdj: 'Aibuin', spy: 'Otum',
  },
  'status.escalated': {
    ...
    myx: 'Yongerwa', kdj: 'Ikwan', spy: 'Owilo Malo',
  },
  'incident.water_contamination': {
    ...
    myx: 'Okufuula Amakasi', kdj: 'Ngikai Taone', spy: 'Met Otaone',
  },
  'incident.broken_water_point': {
    ...
    myx: 'Ettabi Lyamakasi Limenyese', kdj: 'Ngikai Aballe', spy: 'Kabedo Pa Met Aballe',
  },
  'incident.flooding': {
    ...
    myx: 'Amataba', kdj: 'Ngikai Laro', spy: 'Met Olaro',
  },
  'incident.sewage_leak': {
    ...
    laj: 'Nyo Ojwayo', alz: 'Nyo Ojwayo', myx: "Okuseseeka Kw'ekivundu", kdj: 'Nyo Ojwayo', spy: 'Nyo Ojwayo',
  },
  'incident.illegal_dumping': {
    ...
    myx: "Okuteguka Amateeka", kdj: 'Kwero Marac', spy: 'Tun Kwere Marac',
  },
  'incident.pollution': {
    en: 'Pollution', lug: 'Okufuula', nyn: 'Okutamya', teo: 'Aipi', luo: 'Chilo',
    lgg: 'Polushon', xog: 'Okufuula', cgg: 'Okutamya', ach: 'Chilo', swa: 'Uchafuzi',
    nyo: 'Okutamya', ttj: 'Okutamya', laj: 'Taone', alz: 'Taone', myx: 'Okufuula', kdj: 'Taone', spy: 'Taone',
  },
  'incident.environmental_hazard': {
    ...
    laj: 'Arem me Lobo', alz: 'Arem me Lobo', myx: 'Akabi mu Bikolwa', kdj: 'Arem me Ka', spy: 'Arem me Iman',
  },
  'incident.infrastructure_damage': {
    ...
    myx: 'Okwonona Ebyuma', kdj: 'Aibuin', spy: 'Balle Marac',
  },
  'incident.disease_report': {
    ...
    myx: 'Obulwadde / Bwanguzi', kdj: 'Ngidwari / Abui', spy: 'Ng\'alal / Sowondo Ripooto',
  },
  ...
  'alert.success.translate': {
    ...
    myx: 'Ekivvuunulwa', kdj: 'Okitroco maber', spy: 'Iboisiet',
  },
};
