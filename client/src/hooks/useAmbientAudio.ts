...
const SONGS: Record<AmbientTheme, SongProfile> = {
  jarvis: {
    ...
    steps: [
      { beats: 4, notes: [
        { freq: 130.81, gain: 0.035, type: 'sine' },
        { freq: 261.63, gain: 0.028, type: 'triangle' },
        { freq: 329.63, gain: 0.022, type: 'triangle' },
        { freq: 392.00, gain: 0.018, type: 'sine' },
        { freq: 523.25, gain: 0.012, type: 'sine' },
      ]},
      { beats: 4, notes: [
        { freq: 98.00, gain: 0.035, type: 'sine' },
        { freq: 246.94, gain: 0.028, type: 'triangle' },
        { freq: 293.66, gain: 0.022, type: 'triangle' },
        { freq: 392.00, gain: 0.018, type: 'sine' },
        { freq: 493.88, gain: 0.012, type: 'sine' },
      ]},
      { beats: 4, notes: [
        { freq: 110.00, gain: 0.032, type: 'sine' },
        { freq: 220.00, gain: 0.025, type: 'triangle' },
        { freq: 261.63, gain: 0.02, type: 'triangle' },
        { freq: 329.63, gain: 0.016, type: 'sine' },
        { freq: 440.00, gain: 0.01, type: 'sine' },
      ]},
      { beats: 4, notes: [
        { freq: 87.31, gain: 0.032, type: 'sine' },
        { freq: 174.61, gain: 0.025, type: 'triangle' },
        { freq: 220.00, gain: 0.02, type: 'triangle' },
        { freq: 261.63, gain: 0.016, type: 'sine' },
        { freq: 349.23, gain: 0.01, type: 'sine' },
      ]},
      { beats: 2, notes: [
        { freq: 130.81, gain: 0.032, type: 'sine' },
        { freq: 261.63, gain: 0.025, type: 'triangle' },
        { freq: 329.63, gain: 0.02, type: 'triangle' },
        { freq: 392.00, gain: 0.016, type: 'sine' },
        { freq: 523.25, gain: 0.01, type: 'sine' },
      ]},
      { beats: 2, notes: [
        { freq: 87.31, gain: 0.032, type: 'sine' },
        { freq: 174.61, gain: 0.025, type: 'triangle' },
      ...
      { beats: 4, notes: [
        { freq: 98.00, gain: 0.032, type: 'sine' },
        { freq: 196.00, gain: 0.025, type: 'triangle' },
        { freq: 246.94, gain: 0.02, type: 'triangle' },
        { freq: 293.66, gain: 0.016, type: 'sine' },
        { freq: 392.00, gain: 0.01, type: 'sine' },
      ]},
      { beats: 4, notes: [
        { freq: 130.81, gain: 0.04, type: 'sine' },
        { freq: 261.63, gain: 0.032, type: 'triangle' },
        { freq: 329.63, gain: 0.025, type: 'triangle' },
        { freq: 392.00, gain: 0.02, type: 'sine' },
        { freq: 523.25, gain: 0.014, type: 'sine' },
      ]},
    ],
  },
  nature: {
    ...
    steps: [
      { beats: 4, notes: [
        { freq: 146.83, gain: 0.032, type: 'sine' },
        { freq: 293.66, gain: 0.025, type: 'triangle' },
        { freq: 369.99, gain: 0.02, type: 'sine' },
        { freq: 440.00, gain: 0.015, type: 'triangle' },
      ]},
      { beats: 4, notes: [
        { freq: 110.00, gain: 0.032, type: 'sine' },
        { freq: 220.00, gain: 0.025, type: 'triangle' },
        { freq: 277.18, gain: 0.018, type: 'sine' },
        { freq: 329.63, gain: 0.015, type: 'triangle' },
      ]},
      { beats: 4, notes: [
        { freq: 98.00, gain: 0.032, type: 'sine' },
        { freq: 196.00, gain: 0.025, type: 'triangle' },
        { freq: 246.94, gain: 0.018, type: 'sine' },
        { freq: 293.66, gain: 0.015, type: 'triangle' },
      ]},
      { beats: 4, notes: [
        { freq: 130.81, gain: 0.032, type: 'sine' },
        { freq: 261.63, gain: 0.025, type: 'triangle' },
        { freq: 329.63, gain: 0.018, type: 'sine' },
        { freq: 392.00, gain: 0.015, type: 'triangle' },
      ]},
    ],
  },
  crystal: {
    ...
    steps: [
      { beats: 4, notes: [
        { freq: 110.00, gain: 0.028, type: 'sine' },
        { freq: 220.00, gain: 0.022, type: 'triangle' },
        { freq: 261.63, gain: 0.018, type: 'sine' },
        { freq: 329.63, gain: 0.014, type: 'triangle' },
      ]},
      { beats: 4, notes: [
        { freq: 87.31, gain: 0.028, type: 'sine' },
        { freq: 174.61, gain: 0.022, type: 'triangle' },
        { freq: 220.00, gain: 0.018, type: 'sine' },
        { freq: 261.63, gain: 0.014, type: 'triangle' },
      ]},
      { beats: 4, notes: [
        { freq: 130.81, gain: 0.028, type: 'sine' },
        { freq: 261.63, gain: 0.022, type: 'triangle' },
        { freq: 329.63, gain: 0.018, type: 'sine' },
        { freq: 392.00, gain: 0.014, type: 'triangle' },
      ]},
      { beats: 4, notes: [
        { freq: 98.00, gain: 0.028, type: 'sine' },
        { freq: 196.00, gain: 0.022, type: 'triangle' },
        { freq: 246.94, gain: 0.018, type: 'sine' },
        { freq: 293.66, gain: 0.014, type: 'triangle' },
      ]},
    ],
  },
  deepspace: {
    ...
    steps: [
      { beats: 4, notes: [
        { freq: 130.81, gain: 0.03, type: 'sine' },
        { freq: 261.63, gain: 0.022, type: 'triangle' },
        { freq: 311.13, gain: 0.018, type: 'sine' },
        { freq: 392.00, gain: 0.014, type: 'triangle' },
      ]},
      { beats: 4, notes: [
        { freq: 103.83, gain: 0.028, type: 'sine' },
        { freq: 207.65, gain: 0.022, type: 'triangle' },
        { freq: 261.63, gain: 0.018, type: 'sine' },
        { freq: 311.13, gain: 0.014, type: 'triangle' },
      ]},
      { beats: 4, notes: [
        { freq: 77.78, gain: 0.028, type: 'sine' },
        { freq: 155.56, gain: 0.022, type: 'triangle' },
        { freq: 196.00, gain: 0.018, type: 'sine' },
        { freq: 233.08, gain: 0.014, type: 'triangle' },
      ]},
      { beats: 4, notes: [
        { freq: 116.54, gain: 0.028, type: 'sine' },
        { freq: 233.08, gain: 0.022, type: 'triangle' },
        { freq: 293.66, gain: 0.018, type: 'sine' },
        { freq: 349.23, gain: 0.014, type: 'triangle' },
      ]},
    ],
  },
  cyberpunk: {
    ...
    steps: [
      { beats: 4, notes: [
        { freq: 87.31, gain: 0.03, type: 'sine' },
        { freq: 174.61, gain: 0.022, type: 'triangle' },
        { freq: 220.00, gain: 0.018, type: 'triangle' },
        { freq: 261.63, gain: 0.014, type: 'sine' },
      ]},
      { beats: 4, notes: [
        { freq: 69.30, gain: 0.03, type: 'sine' },
        { freq: 138.59, gain: 0.022, type: 'triangle' },
        { freq: 185.00, gain: 0.018, type: 'triangle' },
        { freq: 220.00, gain: 0.014, type: 'sine' },
      ]},
      { beats: 4, notes: [
        { freq: 51.91, gain: 0.03, type: 'sine' },
        { freq: 103.83, gain: 0.022, type: 'triangle' },
        { freq: 138.59, gain: 0.018, type: 'triangle' },
        { freq: 185.00, gain: 0.014, type: 'sine' },
      ]},
      { beats: 4, notes: [
        { freq: 77.78, gain: 0.03, type: 'sine' },
        { freq: 155.56, gain: 0.022, type: 'triangle' },
        { freq: 196.00, gain: 0.018, type: 'triangle' },
        { freq: 233.08, gain: 0.014, type: 'sine' },
      ]},
    ],
  },
};
